...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   { true, RARCH_MENU_UP,                  MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_UP,              RETROK_F1,      NO_BTN, 0, AXIS_NONE },
   { true, RARCH_MENU_DOWN,                MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_DOWN,            RETROK_F1,      NO_BTN, 0, AXIS_NONE },
   { true, RARCH_MENU_LEFT,                MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_LEFT,            RETROK_F1,      NO_BTN, 0, AXIS_NONE },
   { true, RARCH_MENU_RIGHT,               MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_RIGHT,           RETROK_F1,      NO_BTN, 0, AXIS_NONE },
   { true, RARCH_MENU_OK,                  MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_OK,              RETROK_F1,      NO_BTN, 0, AXIS_NONE },
   { true, RARCH_MENU_CANCEL,              MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_CANCEL,          RETROK_F1,      NO_BTN, 0, AXIS_NONE },
#endif
};
