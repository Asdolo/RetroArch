...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_UP,
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_DOWN,
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_LEFT,
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_RIGHT,
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_OK,
   MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_CANCEL,
