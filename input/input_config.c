...
const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
      ...
      DECLARE_META_BIND(1, menu_up,               RARCH_MENU_UP,               MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_UP),
      DECLARE_META_BIND(1, menu_down,             RARCH_MENU_DOWN,             MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_DOWN),
      DECLARE_META_BIND(1, menu_left,             RARCH_MENU_LEFT,             MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_LEFT),
      DECLARE_META_BIND(1, menu_right,            RARCH_MENU_RIGHT,            MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_RIGHT),
      DECLARE_META_BIND(1, menu_ok,               RARCH_MENU_OK,               MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_OK),
      DECLARE_META_BIND(1, menu_cancel,           RARCH_MENU_CANCEL,           MENU_ENUM_LABEL_VALUE_INPUT_META_MENU_CANCEL),
#endif
};
